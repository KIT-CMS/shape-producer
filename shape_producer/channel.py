...
class MSSMvsSMMT2016(Channel):
    def __init__(self):
        ...
        self._cuts = Cuts(
            ...
            #Cut("(trg_mutaucross == 1 && pt_1 <= 23)","trg_selection"))
            Cut("(trg_singlemuon == 1 && pt_1 > 23) || (trg_mutaucross == 1 && pt_1 <= 23)","trg_selection"))
...
class MSSMvsSMMT2017(Channel):
    def __init__(self):
        ...
        self._cuts = Cuts(
            ...
            Cut("iso_1<0.15", "muon_iso"),
            Cut("q_1*q_2<0", "os"),
            Cut("pt_1 > 21 && abs(eta_1) < 2.1 && pt_2 > 30 && abs(eta_2) < 2.1","kinematics"),
            #Cut("(trg_singlemuon_27 == 1 && pt_1 > 28)","trg_selection"))
            #Cut("(trg_crossmuon_mu20tau27 == 1 && pt_1 <= 28 && pt_2 > 32)","trg_selection"))
            Cut("(trg_singlemuon_27 == 1 && pt_1 > 28) || (trg_crossmuon_mu20tau27 == 1 && pt_1 <= 28 && pt_2 > 32)","trg_selection"))
...
class MSSMvsSMMT2018(Channel):
    def __init__(self):
        ...
        self._cuts = Cuts(
            ...
            Cut("pt_1 > 21 && abs(eta_1) < 2.1 && pt_2 > 30 && abs(eta_2) < 2.1","kinematics"),
            #Cut("(trg_singlemuon_27 == 1 && pt_1 > 28)","trg_selection"))
            #Cut("((trg_crossmuon_mu20tau27 == 1 || trg_crossmuon_mu20tau27_hps == 1) && pt_1 <= 28 && pt_2 > 32)","trg_selection"))
            Cut("(trg_singlemuon_27 == 1 && pt_1 > 28) || ((trg_crossmuon_mu20tau27 == 1 || trg_crossmuon_mu20tau27_hps == 1) && pt_1 <= 28 && pt_2 > 32)","trg_selection"))
...
class MSSMvsSMET2016(Channel):
    def __init__(self):
        ...
        self._cuts = Cuts(
            ...
            #Cut("(trg_eletaucross==1 && pt_1<=30)", "trg_selection"))
            Cut("(trg_singleelectron==1 && pt_1 > 30) || (trg_eletaucross==1 && pt_1<=30)", "trg_selection"))
...
class MSSMvsSMET2017(Channel):
    def __init__(self):
        ...
        self._cuts = Cuts(
            ...
            #Cut("((trg_crossele_ele24tau30 == 1 && !isEmbedded || isEmbedded) && pt_1 <= 40 && pt_2 > 35)", "trg_selection"))
            Cut("(trg_singleelectron_35 == 1 && pt_1 > 40) || ((trg_crossele_ele24tau30 == 1 && !isEmbedded || isEmbedded) && pt_1 <= 40 && pt_2 > 35)", "trg_selection"))
...
class MSSMvsSMET2018(Channel):
    def __init__(self):
        ...
        self._cuts = Cuts(
            ...
            #Cut("((trg_crossele_ele24tau30 == 1 || trg_crossele_ele24tau30_hps == 1) && pt_1 <= 37 && pt_2 > 35)", "trg_selection"))
            Cut("(trg_singleelectron_32 == 1 && pt_1 > 37) || ((trg_crossele_ele24tau30 == 1 || trg_crossele_ele24tau30_hps == 1) && pt_1 <= 37 && pt_2 > 35)", "trg_selection"))
