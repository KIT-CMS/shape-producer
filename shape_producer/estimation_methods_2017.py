    ...
    def get_weights(self):
        if self.channel.name in ["mt"]:
            return Weights(
                ...
                Weight("isoWeight_1*idWeight_1*((pt_1>=25 && pt_1<28)*(trigger_24_Weight_1)+(pt_1>=28)*(trigger_24_27_Weight_1)+(pt_1<25)*(crossTriggerCorrectedDataEfficiencyWeight_tight_MVAv2_2/((pt_1<25)*crossTriggerCorrectedEMBEfficiencyWeight_tight_MVAv2_2+(pt_1>=25))*crossTriggerEmbeddedWeight_1))", "lepton_sf"),  # hotfix for old trigger weight
                self.get_tauByIsoIdWeight_for_channel(self.channel.name),
            ...
            return Weights(
                ...
                Weight("(pt_1>=28)+(pt_1<28)*((abs(eta_1)>=1.5)*crossTriggerDataEfficiencyWeight_1*crossTriggerCorrectedDataEfficiencyWeight_tight_MVAv2_2+(abs(eta_1)<1.5)*crossTriggerEmbeddedWeight_1*(crossTriggerCorrectedDataEfficiencyWeight_tight_MVAv2_2/((pt_1<28)*(abs(eta_1)<1.5)*crossTriggerCorrectedEMBEfficiencyWeight_tight_MVAv2_2+(pt_1>=28)+(abs(eta_1)>=1.5))))","cross_trg_weight"),
                Weight("((pt_1>=28)+(pt_1<28)*((abs(eta_1)>=1.5)*crossTriggerDataEfficiencyWeight_1*crossTriggerCorrectedDataEfficiencyWeight_tight_MVAv2_2+(abs(eta_1)<1.5)*crossTriggerEmbeddedWeight_1*(crossTriggerCorrectedDataEfficiencyWeight_tight_MVAv2_2/((pt_1<28)*(abs(eta_1)<1.5)*crossTriggerCorrectedEMBEfficiencyWeight_tight_MVAv2_2+(pt_1>=28)+(abs(eta_1)>=1.5)))))<10.0","cross_trg_cut"),
                ...
                # Weight("((abs(eta_1)>=1.5)*crossTriggerDataEfficiencyWeight_1*crossTriggerCorrectedDataEfficiencyWeight_tight_MVAv2_2+(abs(eta_1)<1.5)*crossTriggerEmbeddedWeight_1*(crossTriggerCorrectedDataEfficiencyWeight_tight_MVAv2_2/((abs(eta_1)<1.5)*crossTriggerCorrectedEMBEfficiencyWeight_tight_MVAv2_2+(abs(eta_1)>=1.5))))","cross_trg_weight"),
                # Weight("(((abs(eta_1)>=1.5)*crossTriggerDataEfficiencyWeight_1*crossTriggerCorrectedDataEfficiencyWeight_tight_MVAv2_2+(abs(eta_1)<1.5)*crossTriggerEmbeddedWeight_1*(crossTriggerCorrectedDataEfficiencyWeight_tight_MVAv2_2/((abs(eta_1)<1.5)*crossTriggerCorrectedEMBEfficiencyWeight_tight_MVAv2_2+(abs(eta_1)>=1.5)))))<10.0","cross_trg_cut"),
