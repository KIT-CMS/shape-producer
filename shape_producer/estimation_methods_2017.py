...
def get_triggerweight_for_channel(channel):
    ...
    if "mt" in channel:
        ...
        trig_sL = "(trg_singleelectron_35)"
        trig_X = "(pt_1>29 && pt_1<=40 && trg_crossele_ele24tau30)"
    ...
    def get_weights(self):
        if self.channel.name in ["mt"]:
            ...
            return Weights(
                ...
                Weight("idWeight_1*isoWeight_1", "lepton_sf"),
                Weight("trigger_27_32_35_Weight_1*(pt_1>40) + (pt_1 <= 40 && pt_1 > 29)*crossTriggerDataEfficiencyWeight_1*crossTriggerDataEfficiencyWeight_tight_DeepTau_2/crossTriggerEMBEfficiencyWeight_tight_DeepTau_2", "triggerweight"),
                self.get_tauByIsoIdWeight_for_channel(self.channel.name),
