...
def get_singlelepton_triggerweight_for_channel(channel):
    ...
    MCTau_1 = "((byTightDeepTau2017v2p1VSjet_1<0.5 && byMediumDeepTau2017v2p1VSjet_1>0.5)*crossTriggerCorrectedMCEfficiencyWeight_medium_DeepTau_1 + (byTightDeepTau2017v2p1VSjet_1>0.5)*crossTriggerCorrectedMCEfficiencyWeight_tight_DeepTau_1)"  # hotfix
    ...
    def get_weights(self):
        if self.channel.name in ["mt"]:
            return Weights(
                ...
                # Weight("isoWeight_1*id_weight_new*((pt_1>=25)*(trigger_24_27_Weight_1)+(pt_1<25)*(abs(eta_2)<2.1)*(crossTriggerDataEfficiencyWeight_tight_DeepTau_2/((pt_1<25)*(abs(eta_2)<2.1)*crossTriggerEMBEfficiencyWeight_tight_DeepTau_2+(abs(eta_2)>=2.1)+(pt_1>=25)))*crossTriggerEmbeddedWeight_1)", "lepton_sf"),
                Weight("isoWeight_1*idWeight_1", "lepton_sf"),
                Weight("((pt_1>=25)*(pt_1<28)*(trigger_24_Weight_1)+(pt_1>=28)*(trigger_24_27_Weight_1)+(pt_1<25)*(abs(eta_2)<2.1)*(crossTriggerCorrectedDataEfficiencyWeight_tight_DeepTau_2/((pt_1<25)*(abs(eta_2)<2.1)*crossTriggerCorrectedEMBEfficiencyWeight_tight_DeepTau_2+(abs(eta_2)>=2.1)+(pt_1>=25)))*crossTriggerEmbeddedWeight_1)", "triggerweight"),  # hotfix
                self.get_tauByIsoIdWeight_for_channel(self.channel.name),
            ...
            return Weights(
                Weight("generatorWeight",
                       "simulation_sf"),
                Weight("muonEffTrgWeight*muonEffIDWeight_1*muonEffIDWeight_2", "scale_factor"),
                Weight("id_weight_new*isoWeight_1", "lepton_sf"),  # hotfix
                ...
                # Weight("id_weight_new*isoWeight_1*(crossTriggerEmbeddedWeight_1*(crossTriggerDataEfficiencyWeight_tight_DeepTau_2/((pt_1<33)*crossTriggerEMBEfficiencyWeight_tight_DeepTau_2+(pt_1>=33)))*(pt_1<33)+(pt_1>=33)*trigger_32_35_Weight_1)", "lepton_sf"),
                self.get_tauByIsoIdWeight_for_channel(self.channel.name),
                # Weight("(pt_2<=20)*1.0+(pt_2>20&&pt_2<=25)*0.93+(pt_2>25&&pt_2<=30)*1.07+(pt_2>30&&pt_2<=35)*1.07+(pt_2>35&&pt_2<=40)*1.08+(pt_2>40)*1.05", "emb_tauID_correction_weight"),
            ...
            return Weights(
                ...
                Weight("muonEffTrgWeight*muonEffIDWeight_1*muonEffIDWeight_2", "scale_factor"),
                Weight("id_weight_new*isoWeight_1*idWeight_2*looseIsoWeight_2",
                       "idiso_lepton_sf"),
