...
def get_triggerweight_for_channel(channel):
    ...
    # MCTau_1 = "((abs(eta_2)<2.1)*((byMediumDeepTau2017v2p1VSjet_1<0.5 && byVLooseDeepTau2017v2p1VSjet_1>0.5)*crossTriggerMCEfficiencyWeight_vloose_DeepTau_1 + (byMediumDeepTau2017v2p1VSjet_1>0.5)*crossTriggerMCEfficiencyWeight_medium_DeepTau_1))"
    MCTau_1 = "((abs(eta_2)<2.1)*((byMediumDeepTau2017v2p1VSjet_1<0.5 && byVLooseDeepTau2017v2p1VSjet_1>0.5)*crossTriggerCorrectedMCEfficiencyWeight_vloose_DeepTau_1 + (byMediumDeepTau2017v2p1VSjet_1>0.5)*crossTriggerCorrectedMCEfficiencyWeight_medium_DeepTau_1))"  # Hotfix for old trigger weights.
...
def get_singlelepton_triggerweight_for_channel(channel):
    ...
    MCTau_1 = "((byMediumDeepTau2017v2p1VSjet_1<0.5 && byMediumDeepTau2017v2p1VSjet_1>0.5)*crossTriggerCorrectedMCEfficiencyWeight_medium_DeepTau_1 + (byMediumDeepTau2017v2p1VSjet_1>0.5)*crossTriggerCorrectedMCEfficiencyWeight_medium_DeepTau_1)"
    MCTau_2 = MCTau_1.replace("_1", "_2")
...
class FakeEstimationTT(DataEstimation):
    ...
    def create_root_objects(self, systematic):
        ...
        aiso_systematic.category.cuts.add(
            Cut(
                "(byMediumDeepTau2017v2p1VSjet_2>0.5&&byMediumDeepTau2017v2p1VSjet_1<0.5&&byVLooseDeepTau2017v2p1VSjet_1>0.5)||(byMediumDeepTau2017v2p1VSjet_1>0.5&&byMediumDeepTau2017v2p1VSjet_2<0.5&&byMediumDeepTau2017v2p1VSjet_2>0.5)",
                "tau_aiso"))
...
class ggHEstimation(HTTEstimation):
    ...
    def get_weights(self):
        ...
        weights.add(Weight("(abs(crossSectionPerEventWeight - 0.538017) > 1e-5)*crossSectionPerEventWeight + (abs(crossSectionPerEventWeight - 0.538017) < 1e-5)*crossSectionPerEventWeight/100.", "crossSectionPerEventWeight"))  # TODO: Hotfix for wrong cross sections in datasets.json, remove once those are corrected
...
class qqHEstimation(HTTEstimation):
    ...
    def get_weights(self):
        ...
        weights.remove("numberGeneratedEventsWeight")
        weights.remove("crossSectionPerEventWeight")
        weights.add(Weight("(numberGeneratedEventsWeight*(abs(crossSectionPerEventWeight - 0.2370687)>1e-4)+1.0/(1499400 + 400000 + 2997000)*(abs(crossSectionPerEventWeight - 0.2370687)<1e-4))", "numberGeneratedEventsWeight")) # 1499400 for inclusive sample and 1999000 for extension
        weights.add(Weight("(abs(crossSectionPerEventWeight - 0.05544)>1e-4)*crossSectionPerEventWeight + (abs(crossSectionPerEventWeight - 0.05544)<1e-4)*0.04774349", "crossSectionPerEventWeight"))  # TODO: Hotfix for wrong cross sections in datasets.json, remove once those are corrected
        return weights
...
class ZTTEmbeddedEstimation(EstimationMethod):
    ...
    def emb_triggerweights(self):
        ...
        EMBTau_1 = "((byMediumDeepTau2017v2p1VSjet_1<0.5 && byVLooseDeepTau2017v2p1VSjet_1>0.5)*crossTriggerCorrectedEMBEfficiencyWeight_vloose_DeepTau_1 + (byMediumDeepTau2017v2p1VSjet_1>0.5)*crossTriggerCorrectedEMBEfficiencyWeight_medium_DeepTau_1)" # hotfix
        # EMBTau_1 = "((byMediumDeepTau2017v2p1VSjet_1<0.5 && byVLooseDeepTau2017v2p1VSjet_1>0.5)*crossTriggerEMBEfficiencyWeight_vloose_DeepTau_1 + (byMediumDeepTau2017v2p1VSjet_1>0.5)*crossTriggerEMBEfficiencyWeight_medium_DeepTau_1)"
